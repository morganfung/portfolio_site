    ...
    return (
        ...
        >
            <div className="container mx-auto max-w-5xl">
                ...
                <p className="text-cente text-muted-foreground mb-12 max-w-2xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                        ...
                        <div className="space-y-6 justify-center">
                            <div className="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <a
                                        href="mailto:morganfung2004@yahoo.com"
                                        className="text-muted-foreground hover:text-primary transition-colors"
                                    >
                                        morganfung2004@yahoo.com
                                    </a>
                                </div>
                            </div>
                            <div className="flex items-start space-x-4">
                    ...
                    <div className="bg-card p-8 rounded-lg shadow-xs">
                        ...
                        <form className="space-y-6">
                            ...
                            <div>
                                <label htmlFor="messsage" className="block text-sm font-medium mb-2">Your Message</label>
                                <textarea
                                    id="message"
                                    name="message"
                                    required
